  ...
  <Navbar.Collapse id="basic-navbar-nav">
    ...
    <span className="navbar-text">
      <div className="social-icon">
        <a href="https://www.linkedin.com/in/parth-bangoria-3bb1b0246"><img src={navIcon1} alt="" /></a>
        {/* <a href="#"><img src={navIcon2} alt="" /></a> */}
        <a href="https://instagram.com/___parth___531?igshid=MzNlNGNkZWQ4Mg=="><img src={navIcon3} alt="" /></a>
      </div>
